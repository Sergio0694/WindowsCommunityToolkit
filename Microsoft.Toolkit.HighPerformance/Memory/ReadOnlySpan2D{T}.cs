...
namespace Microsoft.Toolkit.HighPerformance.Memory
{
    ...
    public readonly ref partial struct ReadOnlySpan2D<T>
    {
        ...
        public static ReadOnlySpan2D<T> DangerousCreate(in T value, int height, int width, int pitch)
        {
            ...
            return new(value, height, width, pitch);
        }
#endif
        ...
        public ReadOnlySpan2D<T> Slice(int row, int column, int width, int height)
        {
            ...
            return new(r0, height, width, pitch);
#else
...
#pragma warning restore CS0809
        ...
        {
#if SPAN_RUNTIME_SUPPORT
            return new(span.DangerousGetReference(), span.Height, span.Width, span.Stride - span.Width);
#else
